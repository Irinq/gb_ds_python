# -*- coding: utf-8 -*-
"""Python basics HW6 Task 3.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Qs6YT7UEVtVYyazemB7j6WLsMJfLPzws
...
class Position(Worker):
    ...
    def get_total_income(self):
        return f'Полный доход сотрудника {self.name} {self.surname} составляет {sum(self._income.values())} руб.'

test = Position(name='Igorina', surname='Petrova', position='doctor', wage=100000, bonus=35000)

test.get_total_income()

test2 = Position(name='Boris', surname='Bublik', position='barber', wage=80000, bonus=28000)

test2.get_full_name()

test2.get_total_income()